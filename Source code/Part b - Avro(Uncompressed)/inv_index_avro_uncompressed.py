...
conf = SparkConf().setAppName("HW3_part2_avro_uncompressed")
...
#Create dataframe and write the file as avro 
inv_index_df=sqlContext.createDataFrame(inv_index)
inv_index_df.write.format("com.databricks.spark.avro").save(sys.argv[3])
